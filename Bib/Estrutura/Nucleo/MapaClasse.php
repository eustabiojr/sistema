...
class MapaClasse
{
    public static function obtMapa()
    {
        ...
        $caminhoClasse['HiCarregadorAplicativostorico'] = 'Bib/Estrutura/Nucleo/HiCarregadorAplicativostorico.php';
        ...
        $caminhoClasse['Historico']                 = 'Bib/Estrutura/Validacao/Historico.php';
